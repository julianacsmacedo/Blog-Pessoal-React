            ...
            <Grid item xs={6} alignItems='center'>
                <Box paddingX={10}>
                    <form onSubmit={onSubmit}>
                        <Typography variant="h3" gutterBottom align="center" component="h3" className="texto-cadastro">Cadastrar</Typography>
                        ...
                        <TextField value={confirmarSenha} onChange={(e: ChangeEvent<HTMLInputElement>) => confirmarSenhaHandle(e)} id="Confirmar Senha" label="confirmarSenha" variant="standard" name="confirmarSenha" margin="normal" type="password" fullWidth />
